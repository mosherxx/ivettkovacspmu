...
export default function HeroGallery({en}:{en:boolean}){
 ...
 const caption=(p:Photo)=>(en?p.caption_en:p.caption_hu)||services.find(s=>s.id===p.service)?.[en?'en':'hu']||(en?'Permanent makeup':'Sminktetoválás');
